...
class AppConfig:
    ...
    # Primary Telegram channel/group for social posts. This is shown in Login & API settings.
    ...
    # Facebook posting uses Meta Graph API only. Browser/cookie posting was removed
    # because Facebook UI selectors are unstable and can target comments/share flows.
...
class PlaywrightSocialService:
    ...
    async def post_facebook(self, text: str, image_path: str | None = None, image_url: str | None = None):
        ...
        if not page_id or not page_access_token:
            raise RuntimeError(
                "Facebook Graph API is not configured. Add FACEBOOK_PAGE_ID and "
                "FACEBOOK_PAGE_ACCESS_TOKEN in the dashboard or Railway Variables. "
